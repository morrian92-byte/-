...
const DeptActions = {
    ...
    categoryPools: {
        '经济': [
            { id:'e1', label:'🏭 招商对接', cost:5, perf:3, conn:2, budget:-5, risk:1,
                desc:'对接有意向投资的企业，推动项目落地', bonus:'25%概率：额外解锁招商项目' },
        ...
        '民生': [
            { id:'l1', label:'🎓 教育走访', cost:2, perf:2, conn:2, budget:-2, risk:0,
                desc:'到学校了解教学质量和设施情况', bonus:'民生指标↑·政绩+1' },
            ...
            { id:'l5', label:'🏘️ 下乡调研', cost:2, perf:2, conn:3, budget:-2, risk:0,
                desc:'到村里调研群众生产生活情况', bonus:'15%概率：发现基层真实问题' },
        ],
        '维稳': [
            ...
            { id:'w4', label:'📞 热线督办', cost:0, perf:2, conn:0, budget:0, risk:0,
                desc:'督办 12345 热线群众诉求办理', bonus:'10%概率：发现重点问题线索' },
            { id:'w5', label:'👁️ 舆情监控', cost:0, perf:1, conn:0, budget:0, risk:1,
                desc:'关注网络舆情，及时发现苗头性问题', bonus:'15%概率：提前发现负面舆情' },
        ],
        '党建': [
            { id:'d1', label:'🏫 主题学习', cost:0, perf:1, conn:2, budget:0, risk:0,
                desc:'组织党员干部开展理论学习', bonus:'灰色风险-2' },
            ...
            { id:'d4', label:'🎯 党日活动', cost:2, perf:2, conn:2, budget:-2, risk:0,
                desc:'组织主题党日活动', bonus:'15%概率：拉近与参与者的关系' },
        ...
        '综合': [
            ...
            { id:'z4', label:'📝 文稿起草', cost:0, perf:2, conn:2, budget:0, risk:0,
                desc:'起草重要会议讲话或汇报材料', bonus:'信息权↑·人脉+2' },
    ...
    deptPools: {
        ...
        '经济发展办': [
            ...
            { id:'jj10', label:'🏭 产业调研', cost:2, perf:2, conn:2, budget:-2, risk:0, desc:'调研本地产业现状和发展瓶颈', bonus:'15%概率：发现产业发展机会' },
        ],
        '财政所': [
        ...
        '发改委': [
            { id:'fg1', label:'🏗️ 项目立项', cost:10, perf:5, conn:2, budget:-10, risk:2, desc:'启动重大项目前期论证和报批', bonus:'30%概率：额外解锁一个重点项目模板' },
            { id:'fg2', label:'📈 经济调度', cost:0, perf:3, conn:2, budget:0, risk:0, desc:'召开经济运行调度会', bonus:'所有项目进度+1' },
            { id:'fg3', label:'📋 规划编制', cost:5, perf:3, conn:2, budget:-5, risk:0, desc:'编制中长期发展规划', bonus:'信息权↑·人脉+1' },
            { id:'fg4', label:'💰 投资审批', cost:0, perf:4, conn:2, budget:0, risk:2, desc:'审批核准重大投资项目', bonus:'25%概率：灰色机会·+25💰' },
            { id:'fg5', label:'🔍 项目稽查', cost:0, perf:2, conn:0, budget:0, risk:1, desc:'稽查在建政府投资项目', bonus:'30%概率：发现问题·可选上报(+政绩3)或压下(+财力20)' },
            { id:'fg6', label:'🏭 产业调研', cost:2, perf:2, conn:1, budget:-2, risk:0, desc:'调研重点产业发展情况', bonus:'' },
            { id:'fg7', label:'📊 物价监测', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'监测市场价格波动', bonus:'10%概率：提前发现通胀风险·政绩+1' },
            ...
            { id:'fg10', label:'🏗️ 基建统筹', cost:0, perf:3, conn:2, budget:0, risk:1, desc:'统筹协调基础设施建设', bonus:'基建项目进度+1' },
        ],
        '财政局': [ // 县级财政局，与乡镇财政所不同
            { id:'xcz1', label:'💳 预算分配', cost:0, perf:4, conn:3, budget:0, risk:1, desc:'制定全县财政预算分配方案', bonus:'信息权↑·人脉+2' },
            { id:'xcz2', label:'🔍 专项审计', cost:0, perf:3, conn:0, budget:0, risk:2, desc:'对重点部门开展专项审计', bonus:'35%概率：选择性处置·政绩+3或灰色+25💰' },
            { id:'xcz3', label:'💰 转移支付', cost:0, perf:3, conn:3, budget:0, risk:0, desc:'争取上级转移支付资金', bonus:'20%概率：获得额外拨款+15💰' },
            ...
            { id:'xcz9', label:'📈 绩效管理', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'推进全面预算绩效管理', bonus:'下月财政收入+3💰' },
        ...
        '住建局': [
            ...
            { id:'zj10', label:'📊 城建统计', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'统计上报城建领域数据', bonus:'10%概率：发现规划漏洞·可选上报' },
        ],
        '交通局': [
            { id:'jt1', label:'🛣️ 工程推进', cost:8, perf:4, conn:1, budget:-8, risk:2, desc:'集中力量推进交通重点项目', bonus:'交通项目进度+2' },
            { id:'jt2', label:'🚌 运输调度', cost:0, perf:2, conn:2, budget:0, risk:0, desc:'协调城乡公共交通运输', bonus:'民生指标↑·政绩+1' },
            { id:'jt3', label:'🔧 公路养护', cost:3, perf:2, conn:0, budget:-3, risk:0, desc:'组织农村公路养护维修', bonus:'民生指标↑·政绩+1' },
            ...
            { id:'jt8', label:'📊 交通规划', cost:0, perf:2, conn:1, budget:0, risk:0, desc:'编制交通发展规划', bonus:'信息权↑·人脉+1' },
        ...
        '城投公司': [
            ...
            { id:'ct2', label:'🤝 融资洽谈', cost:3, perf:2, conn:4, budget:20, risk:2, desc:'对接金融机构争取融资', bonus:'人脉≥60时融资额度翻倍(+40💰)' },
        ...
        // === 民生部门 ===
        '社会事务办': [
            { id:'sh1', label:'🎓 教育督导', cost:0, perf:2, conn:1, budget:0, risk:0, desc:'检查学校教学质量和安全', bonus:'民生指标↑·政绩+1' },
            { id:'sh2', label:'🏥 卫生巡查', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'检查卫生院和卫生室运行', bonus:'安全加固：减少公卫开支+3💰' },
            { id:'sh3', label:'👴 养老走访', cost:2, perf:2, conn:2, budget:-2, risk:0, desc:'走访敬老院和独居老人', bonus:'' },
            { id:'sh4', label:'📋 低保核查', cost:0, perf:2, conn:1, budget:0, risk:0, desc:'核查低保户资格和经济状况', bonus:'15%概率：发现违规领取·可选上报或压下' },
            { id:'sh5', label:'🏘️ 社区活动', cost:2, perf:1, conn:3, budget:-2, risk:0, desc:'组织社区居民文化活动', bonus:'' },
            { id:'sh6', label:'💊 医疗救助', cost:3, perf:2, conn:2, budget:-3, risk:0, desc:'为困难群众申请医疗救助', bonus:'民生指标↑·政绩+1' },
            { id:'sh7', label:'🎓 助学帮扶', cost:2, perf:2, conn:3, budget:-2, risk:0, desc:'帮助贫困学生申请助学金', bonus:'民生指标↑·政绩+1·群众口碑↑' },
        ...
        '农业农村局': [
            { id:'ny1', label:'🌾 产业扶持', cost:5, perf:3, conn:2, budget:-5, risk:0, desc:'扶持特色农产品产业发展', bonus:'30%概率：GDP基线+0.5·持续12月' },
            { id:'ny2', label:'🏘️ 乡村振兴', cost:6, perf:4, conn:3, budget:-6, risk:1, desc:'推进乡村振兴项目建设', bonus:'25%概率：获上级表彰·政绩+2' },
            { id:'ny3', label:'🐄 畜牧防疫', cost:2, perf:2, conn:0, budget:-2, risk:1, desc:'组织畜禽疫病防控', bonus:'安全加固：减少疫病损失+3💰' },
            { id:'ny4', label:'💧 水利建设', cost:5, perf:3, conn:1, budget:-5, risk:1, desc:'推进农田水利设施建设', bonus:'民生指标↑·政绩+2' },
        ...
        '教育局': [
            ...
            { id:'jy2', label:'🏫 校园安全', cost:2, perf:2, conn:0, budget:-2, risk:1, desc:'全面排查校园安全隐患', bonus:'安全加固：减少事故开支+3💰' },
            ...
            { id:'jy5', label:'🏗️ 学校建设', cost:8, perf:4, conn:2, budget:-8, risk:1, desc:'推进新学校或改扩建项目', bonus:'民生指标↑·政绩+2' },
            { id:'jy6', label:'💻 信息化建设', cost:3, perf:2, conn:1, budget:-3, risk:0, desc:'推进教育信息化设备采购', bonus:'10%概率：获得上级关注' },
            ...
            { id:'jy9', label:'🍎 营养餐监管', cost:0, perf:2, conn:0, budget:0, risk:1, desc:'监管学生营养餐食品安全', bonus:'15%概率：发现食品安全问题线索' },
            { id:'jy10', label:'🏅 评优评先', cost:0, perf:1, conn:3, budget:0, risk:0, desc:'组织优秀教师评选表彰', bonus:'' },
        ],
        '卫健委': [
            { id:'wj1', label:'💉 公卫防控', cost:3, perf:3, conn:0, budget:-3, risk:1, desc:'加强公共卫生监测防控', bonus:'安全加固：减少公卫开支+3💰' },
            { id:'wj2', label:'🏥 医改推进', cost:6, perf:4, conn:2, budget:-6, risk:1, desc:'推进基层医疗体制改革', bonus:'25%概率：获上级表彰·政绩+2' },
            ...
            { id:'wj5', label:'💊 药品监管', cost:0, perf:2, conn:0, budget:0, risk:1, desc:'监管药品采购和使用安全', bonus:'30%概率：发现药品回扣线索' },
            { id:'wj6', label:'🏥 基层建设', cost:5, perf:3, conn:2, budget:-5, risk:1, desc:'推进乡镇卫生院标准化建设', bonus:'民生指标↑·政绩+2' },
        ...
        // === 维稳部门 ===
        '综治办': [
            { id:'zz1', label:'📝 信访化解', cost:0, perf:2, conn:1, budget:0, risk:1, desc:'主动约访重点信访人员', bonus:'成功化解：政绩+2·群体风险-10%' },
            { id:'zz2', label:'🔐 安全排查', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'排查辖区安全隐患', bonus:'安全加固：减少事故应急开支+5💰' },
            { id:'zz3', label:'👁️ 网格巡查', cost:0, perf:1, conn:1, budget:0, risk:0, desc:'组织网格员日常巡查', bonus:'5%概率：发现安全隐患' },
            ...
            { id:'zz6', label:'🚨 治安巡逻', cost:0, perf:1, conn:0, budget:0, risk:1, desc:'组织治安联防巡逻', bonus:'安全加固：治安风险降低' },
            { id:'zz7', label:'📞 热线受理', cost:0, perf:1, conn:1, budget:0, risk:0, desc:'受理 12345 热线转办事项', bonus:'' },
            { id:'zz8', label:'🔔 重点管控', cost:0, perf:2, conn:0, budget:0, risk:2, desc:'对重点人员进行管控', bonus:'安全加固：风险事件概率降低' },
            { id:'zz9', label:'📊 治安研判', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'分析研判辖区治安形势', bonus:'' },
            { id:'zz10', label:'🏘️ 平安创建', cost:2, perf:2, conn:2, budget:-2, risk:0, desc:'推进平安社区创建活动', bonus:'15%概率：获评平安单位·政绩+2' },
        ],
        '公安局': [
            { id:'ga1', label:'👮 专项行动', cost:3, perf:4, conn:1, budget:-3, risk:2, desc:'组织治安专项整治行动', bonus:'安全加固：治安风险降低·政绩+2' },
            ...
            { id:'ga10', label:'🚨 应急处突', cost:2, perf:3, conn:0, budget:-2, risk:3, desc:'组织突发事件应急处置', bonus:'成功处置：上级关注·政绩+3' },
        ],
        '应急管理局': [
            { id:'yj1', label:'🚨 应急演练', cost:3, perf:2, conn:1, budget:-3, risk:0, desc:'组织安全生产应急演练', bonus:'安全加固：减少伤亡善后开支+3💰' },
            ...
            { id:'yj7', label:'📝 事故调查', cost:0, perf:3, conn:0, budget:0, risk:3, desc:'牵头调查生产安全事故', bonus:'35%概率：发现管理漏洞线索' },
            ...
            { id:'yj10', label:'🔔 预警发布', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'发布自然灾害预警信息', bonus:'安全加固：减少突发事件损失+3💰' },
        ],
        '信访局': [
            { id:'xf1', label:'🤝 领导接访', cost:0, perf:2, conn:2, budget:0, risk:1, desc:'安排领导接待信访群众', bonus:'成功接访：人脉+2·信访率下降' },
            { id:'xf2', label:'📞 热线督办', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'督办 12345 热线办理', bonus:'' },
            { id:'xf3', label:'📋 积案化解', cost:2, perf:3, conn:2, budget:-2, risk:1, desc:'攻坚化解信访积案', bonus:'成功化解：政绩+2·群体风险-10%' },
        ...
        '组织办': [
            ...
            { id:'zzb2', label:'🏫 党校培训', cost:2, perf:2, conn:2, budget:-2, risk:0, desc:'组织干部参加党校学习', bonus:'15%概率：发现可培养下属' },
            { id:'zzb3', label:'📊 班子研判', cost:0, perf:2, conn:3, budget:0, risk:0, desc:'分析研判各单位班子运行', bonus:'信息权↑·人脉+2' },
            { id:'zzb4', label:'👤 人事档案', cost:0, perf:1, conn:1, budget:0, risk:0, desc:'整理完善干部人事档案', bonus:'' },
            { id:'zzb5', label:'🎯 换届筹备', cost:2, perf:2, conn:3, budget:-2, risk:1, desc:'筹备基层党组织换届', bonus:'信息权↑·人脉+2' },
            ...
            { id:'zzb8', label:'🏅 评优推荐', cost:0, perf:1, conn:4, budget:0, risk:0, desc:'推荐优秀干部参加评选', bonus:'25%概率：推荐成功·人脉+3' },
            { id:'zzb9', label:'🔍 任职审查', cost:0, perf:2, conn:1, budget:0, risk:1, desc:'开展干部任职资格审查', bonus:'' },
            { id:'zzb10', label:'📝 述职评议', cost:0, perf:2, conn:2, budget:0, risk:0, desc:'组织干部述职评议大会', bonus:'15%概率：获得上级关注' },
        ],
        '组织部': [
            ...
            { id:'zzbr4', label:'📋 编制管理', cost:0, perf:2, conn:2, budget:0, risk:0, desc:'管理全县行政事业编制', bonus:'信息权↑·人脉+1' },
            ...
            { id:'zzbr8', label:'📈 职务晋升', cost:0, perf:3, conn:5, budget:0, risk:2, desc:'研究干部职级晋升方案', bonus:'25%概率：推荐成功·亲信晋升+人脉+5' },
            { id:'zzbr9', label:'💼 公开选拔', cost:2, perf:3, conn:2, budget:-2, risk:1, desc:'组织公开选拔领导干部', bonus:'20%概率：获得上级关注' },
        ...
        '纪委': [
            ...
            { id:'jw3', label:'📋 立案审查', cost:0, perf:4, conn:-3, budget:0, risk:4, desc:'对有问题的干部立案审查', bonus:'查办成功：政绩+5·人脉-10' },
            { id:'jw4', label:'🔔 作风督查', cost:0, perf:2, conn:0, budget:0, risk:1, desc:'督查各单位作风建设', bonus:'15%概率：发现作风问题线索' },
            { id:'jw5', label:'💼 谈话函询', cost:0, perf:2, conn:1, budget:0, risk:2, desc:'对轻微问题进行谈话提醒', bonus:'15%概率：发现新线索' },
            { id:'jw6', label:'📊 数据比对', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'通过大数据筛查违纪线索', bonus:'30%概率：发现灰色操作线索' },
            { id:'jw7', label:'🔐 案件审理', cost:0, perf:3, conn:0, budget:0, risk:3, desc:'审理违纪案件并做出处分建议', bonus:'政绩+3' },
            { id:'jw8', label:'📝 巡视整改', cost:0, perf:2, conn:1, budget:0, risk:1, desc:'督促各单位落实巡视整改', bonus:'灰色风险-2' },
            { id:'jw9', label:'👁️ 明察暗访', cost:2, perf:3, conn:0, budget:-2, risk:2, desc:'对重点问题开展明察暗访', bonus:'30%概率：发现灰色操作线索' },
            { id:'jw10', label:'🏛️ 以案促改', cost:0, perf:2, conn:1, budget:0, risk:0, desc:'推动发案单位以案促改', bonus:'灰色风险-2' },
        ],
        '团县委': [
            { id:'tw1', label:'🌟 青年活动', cost:2, perf:2, conn:4, budget:-2, risk:0, desc:'组织青年干部交流活动', bonus:'15%概率：发现优秀青年·可培养' },
            { id:'tw2', label:'🎯 推优入党', cost:0, perf:2, conn:3, budget:0, risk:0, desc:'推荐优秀青年加入党组织', bonus:'推荐成功：人脉+1持续6月' },
            { id:'tw3', label:'🏫 团课培训', cost:0, perf:1, conn:2, budget:0, risk:0, desc:'组织团员青年团课学习', bonus:'15%概率：发现可培养青年' },
            { id:'tw4', label:'🤝 志愿服务', cost:1, perf:2, conn:3, budget:-1, risk:0, desc:'组织青年志愿服务活动', bonus:'群众口碑↑·人脉+1' },
            { id:'tw5', label:'💼 创业扶持', cost:3, perf:2, conn:3, budget:-3, risk:0, desc:'扶持青年创新创业项目', bonus:'' },
            { id:'tw6', label:'🏅 五四表彰', cost:2, perf:2, conn:3, budget:-2, risk:0, desc:'组织五四青年节表彰活动', bonus:'20%概率：上级关注·人脉+2' },
            ...
            { id:'tw9', label:'📊 团内统计', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'完成团内组织统计', bonus:'10%概率：发现优秀青年' },
            { id:'tw10', label:'🎓 青马工程', cost:2, perf:2, conn:3, budget:-2, risk:0, desc:'推进青年马克思主义者培养', bonus:'15%概率：发现可培养下属' },
        ],

        // === 综合部门 ===
        '党政办': [
            { id:'dz1', label:'📄 综合协调', cost:0, perf:2, conn:2, budget:0, risk:0, desc:'协调各部门推进重点工作', bonus:'所有项目进度+1' },
            { id:'dz2', label:'📰 信息报送', cost:0, perf:1, conn:2, budget:0, risk:0, desc:'向上级报送工作亮点信息', bonus:'20%概率：上级采纳·人脉+2' },
            ...
            { id:'dz5', label:'📋 文件流转', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'处理来文来电和文件传阅', bonus:'5%概率：发现重要信息线索' },
            { id:'dz6', label:'🔐 机要保密', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'做好机要文件保密管理', bonus:'信息权↑·人脉+1' },
            { id:'dz7', label:'📊 督查督办', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'对交办事项进行督查', bonus:'滞后项目进度+2' },
            { id:'dz8', label:'🤝 公务接待', cost:2, perf:1, conn:3, budget:-2, risk:1, desc:'接待上级来人来访', bonus:'后续社交成本-2·持续3月' },
            { id:'dz9', label:'📅 日程安排', cost:0, perf:1, conn:1, budget:0, risk:0, desc:'协调安排领导日程', bonus:'10%概率：提前获知人事动向' },
        ...
        '县委办': [
            ...
            { id:'xwb8', label:'📋 值班值守', cost:0, perf:1, conn:0, budget:0, risk:0, desc:'做好县委值班应急工作', bonus:'10%概率：获知突发事件·提前应对' },
            { id:'xwb9', label:'🔍 政策研究', cost:0, perf:2, conn:1, budget:0, risk:0, desc:'研究上级重大决策部署', bonus:'信息权↑·人脉+1' },
        ...
        '人社局': [
            ...
            { id:'rs3', label:'💼 劳动仲裁', cost:0, perf:2, conn:1, budget:0, risk:1, desc:'调解劳动人事争议', bonus:'15%概率：发现企业违规线索' },
            { id:'rs4', label:'📋 工资福利', cost:0, perf:1, conn:2, budget:0, risk:0, desc:'核定调整干部职工工资', bonus:'' },
            { id:'rs5', label:'🏅 职称评审', cost:0, perf:2, conn:3, budget:0, risk:1, desc:'组织专业技术职称评审', bonus:'20%概率：人脉+2' },
            ...
            { id:'rs10', label:'💰 就业扶持', cost:3, perf:2, conn:2, budget:-3, risk:0, desc:'落实就业创业扶持政策', bonus:'民生指标↑·政绩+1' },
        ],
        '审计局': [
            ...
            { id:'sj4', label:'🏗️ 投资项目', cost:0, perf:3, conn:0, budget:0, risk:2, desc:'审计政府投资项目造价', bonus:'35%概率：发现造价问题·可选追回(+政绩3)或灰色(+财力30)' },
            { id:'sj5', label:'📊 数据分析', cost:0, perf:2, conn:0, budget:0, risk:0, desc:'通过数据分析发现审计疑点', bonus:'' },
            { id:'sj6', label:'📝 审计报告', cost:0, perf:2, conn:1, budget:0, risk:1, desc:'撰写审计报告提出建议', bonus:'35%概率：发现问题·可选上报或压下' },
            ...
            { id:'sj10', label:'🏛️ 移送线索', cost:0, perf:3, conn:0, budget:0, risk:3, desc:'向纪委移送审计发现问题线索', bonus:'纪委受理：政绩+2·被查方态度-5' },
        ],
    },
